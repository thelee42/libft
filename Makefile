...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/11/25 21:29:09 by thelee            #+#    #+#              #
#    Updated: 2023/11/29 13:40:46 by thelee           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFILES = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
     ...
     ft_atoi.c ft_bzero.c ft_calloc.c ft_toupper.c ft_tolower.c \
     ft_memcpy.c ft_memmove.c ft_memset.c ft_memchr.c ft_memcmp.c \
     ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c \
     ft_strmapi.c ft_striteri.c \
     ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c \

CFILES_BONUS = ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstlast.c \
...
so:
	$(CC) -nostartfiles -fPIC $(CFLAGS) $(CFILES) $(CFILES_BONUS)
	gcc -nostartfiles -shared -o libft.so $(OFILES) $(OFILES_BONUS)
